...
function generate_grid(){
	...
	for (var i=0; i<26; i++){
		...
		newRow.classList.add("columns", "is-multiline", "is-mobile", "is-centered", "has-margin-right-100", "has-margin-left-100"); 
...
//			img.loading="lazy"; 
			...
			if (seven!==7 && (arcImgs.length>0)){
				...
				if (captionText.includes("png")){
				  captionText = captionText.replace(".png", ""); 
				}
				img.alt = captionText; 
				seven = 0; 
			}
