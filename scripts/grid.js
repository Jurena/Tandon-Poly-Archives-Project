...
function generate_grid(){
	...
	for (var i=0; i<26; i++){
		...
		newRow.classList.add("columns", "is-multiline", "is-mobile", "is-centered", "has-margin-right-80", "has-margin-left-80"); 
		for (var ind=0; ind<5; ind++){
			imgCol = document.createElement("div"); 
			imgCol.classList.add("column", "is-one-fifth-desktop", "is-one-fifth-mobile", "image");
			img = document.createElement("img"); 
			if (seven!==7 && (arcImgs.length>0)){
				//.shift() removes the first element of an array whereas .pop() removes the last
				img.src = "../Tandon-Poly-Archives-Project/img/Archive Images/" + arcImgs.shift(); 
				seven+=1; 
			}
			else{
				
				img.src = "../Tandon-Poly-Archives-Project/img/Clothing Images/" + appImgs.pop(); 
				seven = 0; 
			}
